...
void OscManager::fireMessage(ofxOscMessage *m){
    ...
    }else if(m->getAddress() == "/point_x2"){
        float fnum = m->getArgAsFloat(0);
        ofNotifyEvent(chgPointX2, fnum);
    }else if(m->getAddress() == "/point_y2"){
        float fnum = m->getArgAsFloat(0);
        ofNotifyEvent(chgPointY2, fnum);
    }else if(m->getAddress() == "/point_x3"){
        float fnum = m->getArgAsFloat(0);
        ofNotifyEvent(chgPointX3, fnum);
    }else if(m->getAddress() == "/point_y3"){
        float fnum = m->getArgAsFloat(0);
        ofNotifyEvent(chgPointY3, fnum);
    }else if(m->getAddress() == "/point_x4"){
        float fnum = m->getArgAsFloat(0);
        ofNotifyEvent(chgPointX4, fnum);
    }else if(m->getAddress() == "/point_y4"){
        float fnum = m->getArgAsFloat(0);
        ofNotifyEvent(chgPointY4, fnum);
    ...
    }else if(m->getAddress() == "/mask_left"){
        float fnum = m->getArgAsFloat(0);
        ofNotifyEvent(chgMaskLeft, fnum);
    }else if(m->getAddress() == "/mask_right"){
        float fnum = m->getArgAsFloat(0);
        ofNotifyEvent(chgMaskRight, fnum);
    }
