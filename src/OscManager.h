...
class OscManager:public slOscManager {
    ...
    ofEvent<float> chgPointX2; //Add your own event and invole it in receiveMessage
    ofEvent<float> chgPointY2; //Add your own event and invole it in receiveMessage
    ofEvent<float> chgPointX3; //Add your own event and invole it in receiveMessage
    ofEvent<float> chgPointY3; //Add your own event and invole it in receiveMessage
    ofEvent<float> chgPointX4; //Add your own event and invole it in receiveMessage
    ofEvent<float> chgPointY4; //Add your own event and invole it in receiveMessage
    ...
    ofEvent<float> chgMaskLeft; //Add your own event and invole it in receiveMessage
    ofEvent<float> chgMaskRight; //Add your own event and invole it in receiveMessage
